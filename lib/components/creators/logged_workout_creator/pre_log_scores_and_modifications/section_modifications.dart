...
class PreLoggingSectionModifications extends StatelessWidget {
  final int sectionIndex;
  const PreLoggingSectionModifications({Key? key, required this.sectionIndex})
      : super(key: key);
  ...
  void _updateDuration(
    ...
    if (copyToAll) {
      context.read<WorkoutStructureModificationsBloc>().updateAllSetDurations(
          sectionIndex,
          duration.inSeconds,
  ...
  Widget build(BuildContext context) {
    final activeWorkoutSection =
        context.select<WorkoutStructureModificationsBloc, WorkoutSection>(
        ...
        child: ListView(
          children: [
            ...
            ImplicitlyAnimatedList<WorkoutSet>(
              ...
              // Assumed that adding [activeWorkoutSection] hashCode means that this list is only rebuild when a new section object is being rendered. WorkoutStructureModificationsBloc creates a new section when it does any update.
