...
class AppRouter extends _i60.RootStackRouter {
  ...
  final Map<String, _i60.PageFactory> pagesMap = {
    ...
    ClubCreatorRoute.name: (routeData) {
      ...
      return _i60.CupertinoPageX<dynamic>(
          routeData: routeData,
          child: _i42.ClubCreatorPage(key: args.key, club: args.club));
    },
  ...
  List<_i60.RouteConfig> get routes => [
        ...
        _i60.RouteConfig(AuthedRouter.name, path: '/', children: [
          ...
          _i60.RouteConfig(JournalRoute.name,
          ...
          _i60.RouteConfig(ProfilePublicWorkoutsRoute.name,
              path: 'public-workouts/:userId', parent: AuthedRouter.name),
          _i60.RouteConfig(ProfilePublicWorkoutPlansRoute.name,
...
/// generated route for
/// [_i25.JournalPage]
class JournalRoute extends _i60.PageRouteInfo<void> {
...
class ProfilePublicWorkoutsRoute
    extends _i60.PageRouteInfo<ProfilePublicWorkoutsRouteArgs> {
  ProfilePublicWorkoutsRoute(
      {_i62.Key? key, required String userId, String? userDisplayName})
...
class ProfilePublicWorkoutPlansRoute
    extends _i60.PageRouteInfo<ProfilePublicWorkoutPlansRouteArgs> {
...
/// generated route for
/// [_i49.ScheduledWorkoutCreatorPage]
...
/// generated route for
/// [_i53.WorkoutPlanReviewCreatorPage]
