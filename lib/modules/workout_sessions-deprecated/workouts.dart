...
//   const WorkoutsPage({Key? key, this.previousPageTitle}) : super(key: key);
...
//         middle: const NavBarTitle('Workouts'),
//       ),
//       child: QueryObserver<UserWorkoutSessions$Query, json.JsonSerializable>(
//           key:
//               Key('WorkoutsPage - ${UserWorkoutSessionsQuery().operationName}'),
//           query: UserWorkoutSessionsQuery(),
//           builder: (resistance) {
//             return MyText(resistance
//                 .userWorkoutSessions.resistanceSessions.length
//                 .toString());
//           }),
//     );
//   }
...
// //     context.router.popUntilRouteWithName(WorkoutsRoute.name);
// //     context.pop();
