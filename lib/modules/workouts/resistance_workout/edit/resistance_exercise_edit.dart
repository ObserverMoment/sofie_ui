...
import 'package:sofie_ui/modules/workouts/resistance_workout/edit/resistance_set_edit.dart';
...
class ResistanceExerciseEdit extends StatelessWidget {
  ...
  void _handleAddMove(BuildContext context) {
    context.push(
        ...
        child: MoveSelector(
            selectMove: (m) {
              context.read<ResistanceWorkoutBloc>().createResistanceSet(
  ...
  Widget build(BuildContext context) {
    ...
    final resistanceExercise = bloc.resistanceWorkout.resistanceExercises
