...
class GraphQLStoreV2 {
  ...
  /// Should only ever be one instance per runtime of GraphQLStoreV2.
  static GraphQLStoreV2 get store => GetIt.I<GraphQLStoreV2>();
  ...
  bool _queryStore(String id) {
    ...
    if (observableQuery == null) {
      ...
      try {
        ...
        final data = readDenomalized(observableQuery.id);
